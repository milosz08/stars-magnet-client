 ...
 *   Created at: 2023-08-31, 00:26:04
 *   Last updated at: 2023-08-31, 00:26:08
...
const containerName = 'stars-magnet-client';
...
async function processing() {
  try {
    ...
    await createPromisifyProcess({
      ...
      messOnStart: 'Compiling angular bundles',
      messOnEnd: 'compiled angular bundles',
